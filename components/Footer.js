  ...
  return (
    <footer className={`bg-[#b5c18e] py-4 flex flex-col justify-center gap-4 items-center text-[#282424] ${openSans.className} w-full gap-2 z-40 shadow-[0px_-10px_40px_rgba(0,0,0,0.3)]`}>
      <div className='flex flex-col md:flex-row w-11/12 justify-evenly rounded-lg bg-[#eee2d8] py-4 items-center gap-1 md:gap-4 font-semibold text-base lg:text-lg xl:text-xl '>
        ...
        <Link href={'/about'} className='p-3 w-2/12 text-center hover:bg-[#bd783c] hover:text-[#f2f5fe] rounded-lg'>About</Link>
        <div className="border-[#bd783c] border w-9/12 md:hidden block"></div>

        <Link href={'/faq'} className='p-3 w-2/12 text-center hover:bg-[#bd783c] hover:text-[#f2f5fe] rounded-lg'>FAQ</Link>
        <div className="border-[#bd783c] border w-9/12 md:hidden block"></div>

        <Link href={'/login'} className='p-3 w-2/12 text-center hover:bg-[#bd783c] hover:text-[#f2f5fe] rounded-lg'>Login</Link>
        <div className="border-[#bd783c] border w-9/12 md:hidden block"></div>

        <Link href={'/login'} className='p-3 w-2/12 text-center hover:bg-[#bd783c] hover:text-[#f2f5fe] rounded-lg'>Signup</Link>
        <div className="border-[#bd783c] border w-9/12 md:hidden block"></div>

        <div className='flex w-3/12 text-center justify-center gap-6 md:gap-4 items-center mt-2 md:mt-0'>
